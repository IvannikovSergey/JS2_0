...
let ar1 = ['hello', 2021, true]; // переменную обьявляем здесь!!!!
...
let ar2 = ['hello', 2021, true];// переменную обьявляем здесь!!!!
...
let ar3 = ['hello', 2021, true]; // переменную обьявляем здесь!!!!

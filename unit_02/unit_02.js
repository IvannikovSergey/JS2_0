...
function t12() {
    ...
    let soName = document.querySelector('.i-12-2').value;
    document.querySelector('.out-12').innerHTML = 'Hello ' + name + ' ' + soName;
}
...
function t16() {
    ...
    document.querySelector('.out-16').innerHTML = Number(a) + Number(b);
}

...
function f9() {
    this.classList.toggle('bg-orange'); //this.classList...  // все решается одной строкой
}
...
let div10 = document.querySelectorAll('.out-10'); //let div10 = тут получите все out-10

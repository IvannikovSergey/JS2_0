...
let goods3 = new Goods2('Череп', 2000, 'img/1.png', 5, true);
...
let valid = new Valid('email', '12345', false);
valid.validate();
...
let valid1 = new Valid('email', '1234567');
valid1.validate();
...
let valid2 = new Valid2('', '12345678', 'email empty', 'min length 6');
...
let valid3 = new Valid2('mymail@mail.com', '1234567');
let out12 = valid3.validate();
console.log(valid3);